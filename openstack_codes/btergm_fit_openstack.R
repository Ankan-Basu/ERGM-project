...
if (net_type == 'comments') {
  ...
  input_prefix = './openstack_codes/data/co-comment/Comments_modif50_';
} else if (net_type == 'changes') {
  #input_prefix = './tergm/data/co-change/Changes_modif50_';
  input_prefix = './openstack_codes/data/co-change/Changes_modif50_';
}
...
x <- get_network_list(1, start = 30, end=50);
